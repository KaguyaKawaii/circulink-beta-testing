...
function Dashboard({ user, setView, setSelectedReservation }) {
  ...
  return (
    <main className="min-h-screen w-full bg-[#FFFCFB]">
      {/* Mobile Spacer */}
      ...
      <header className="bg-white text-black px-4 sm:px-6 h-[60px] flex items-center justify-between shadow-sm border-b border-gray-200">
        ...
        <div className="w-10 h-10 lg:hidden"></div> {/* Spacer for mobile */}
      </header>
      ...
      <div className="p-4 sm:p-6">
        <div className="flex flex-col xl:flex-row gap-4 sm:gap-6">
          ...
          <div className="flex-1 flex flex-col gap-4 sm:gap-6">
            ...
            {/* User Reservations */}
            <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200/75 hover:border-gray-300/75 transition-all duration-300 shadow-lg hover:shadow-xl rounded-2xl flex-1 p-4 sm:p-6 flex flex-col">
              ...
              {isLoading ? (
                ...
                <div>
                  {currentReservations.map((reservation) => (
                    <section
                      key={reservation._id}
                      className="border border-gray-200 rounded-xl p-4 sm:p-5 bg-white shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col mb-4"
                    >
                ...
                <div className="text-center py-6 sm:py-8 flex flex-col justify-center items-center">
