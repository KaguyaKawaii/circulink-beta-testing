          ...
          <div className="mt-8">
            ...
            <div className="flex justify-center gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-red-100 text-sm">Enhanced Security</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-3 border border-white/20">
                  <Lock size={28} className="text-white" />
                </div>
                <p className="text-red-100 text-sm">Two-Factor Auth</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-3 border border-white/20">
                  <Mail size={28} className="text-white" />
                </div>
                <p className="text-red-100 text-sm">OTP Verification</p>
              </div>
            </div>
