      ...
      <main className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 p-8 text-center">
            <div className="w-20 h-20 bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-6 border border-red-800/50">
            ...
            <button
              onClick={resetLogin}
              className="w-full py-3 rounded-xl bg-gray-700 hover:bg-gray-600 text-gray-200 font-semibold transition-colors duration-300"
            >
              Return to Login
            </button>
          </div>
    ...
    <main className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      {loading && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-900/95 backdrop-blur-sm">
          <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl flex flex-col items-center border border-blue-500/30">
            <div className="relative">
              <Loader2 size={64} className="text-blue-400 animate-spin mb-4" />
            </div>
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
          {/* Header Section */}
          <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white p-8 text-center relative">
            <div className="absolute top-4 right-4">
              <div className="bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
                <span className="text-xs font-medium text-blue-200">Secure Portal</span>
              </div>
            </div>
            ...
            <h2 className="text-xl font-semibold text-blue-100 mb-3">Learning Resource Center</h2>
          ...
          <div className="p-8">
            ...
            {error && (
              <div className="bg-red-900/20 border border-red-800 text-red-200 p-4 rounded-lg mb-6 animate-fade-in">
            ...
            {requiresOTP ? (
              ...
              <form onSubmit={handleOTPVerification} className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-blue-300 font-semibold mt-1">{adminEmail}</p>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    className="w-full border border-gray-700 bg-gray-900 p-4 rounded-xl text-center text-2xl font-mono tracking-widest text-white placeholder-gray-500 transition-all duration-300 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-900"
                    type="text"
                    placeholder="000000"
                    maxLength="6"
                    value={otp}
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    onClick={resetLogin}
                    disabled={loading}
                    className="flex-1 py-3 rounded-xl bg-gray-700 hover:bg-gray-600 font-semibold text-gray-200 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-600"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="flex-1 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 font-semibold text-white transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Verify Code
                  </button>
                </div>
                ...
                <div className="text-center pt-4 border-t border-gray-700">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 text-blue-400 hover:text-blue-300 font-medium transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed mx-auto text-sm"
                  >
                    <RotateCcw size={16} />
              ...
              <form onSubmit={handleAdminLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    className="w-full border border-gray-700 bg-gray-900 p-4 rounded-xl text-white placeholder-gray-500 focus:border-blue-500 transition-all duration-300 outline-none focus:ring-2 focus:ring-blue-900"
                    type="text"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      className="w-full border border-gray-700 bg-gray-900 p-4 rounded-xl text-white placeholder-gray-500 focus:border-blue-500 transition-all duration-300 outline-none focus:ring-2 focus:ring-blue-900 pr-12"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-blue-400 transition-colors duration-200 p-1"
                      disabled={loading}
                    >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 font-semibold text-white transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <div className="mt-8 text-center">
          <div className="mb-4">
            <button
              onClick={handleBackToUserLogin}
              className="text-gray-400 hover:text-gray-200 transition-colors duration-300 text-sm font-medium"
            >
