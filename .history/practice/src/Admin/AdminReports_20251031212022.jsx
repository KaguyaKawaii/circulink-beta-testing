  ...
  const filteredAndSortedReports = React.useMemo(() => {
    ...
    if (sortConfig.key) {
      filtered.sort((a, b) => {
        ...
        if (sortConfig.key === 'assignedTo' && a.assignedTo) {
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <select
                      ...
                      className="text-sm border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-red-500 outline-0"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 border border-gray-300 rounded hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                      <ChevronLeft size={16} />
                    </button>
