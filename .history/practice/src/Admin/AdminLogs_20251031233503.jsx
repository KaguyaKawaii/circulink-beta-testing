...
function AdminLogs({ setView }) {
  ...
  return (
    <>
      ...
      {/* Main Content - Fixed positioning and width */}
      <main className={`${isConsoleFullscreen ? 'fixed inset-0 z-30' : 'relative ml-[250px]'} min-h-screen bg-gray-50 transition-all duration-300`}>
