...
function AdminDashboard({ setView }) {
  ...
  const processFetchedData = (data) => {
    ...
    // Filter out inactive rooms and ensure data consistency
    const activeRooms = uniqueRooms.filter(room => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {rooms.map(room => {
                    ...
                    return (
                      <div
                        key={room._id}
                        className="p-4 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-white to-gray-50/50"
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center space-x-3">
                            <div className="p-2 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 text-gray-600 shadow-inner">
                              <Home size={18} />
                            </div>
                            <div>
                          ...
                          <div className="mt-4 pt-3 border-t border-gray-100">
                            ...
                            <div className="space-y-2">
                              {bookings.slice(0, 2).map((booking, index) => (
                                <div key={index} className="flex justify-between items-center text-sm bg-white p-2 rounded-lg border border-gray-100">
                              ...
                              {bookings.length > 2 && (
                                <p className="text-xs text-gray-500 text-center pt-2 bg-gray-50 py-1 rounded-lg border border-gray-100">
