      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            {/* Enhanced Room Availability with Floor Grouping */}
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50/50">
                          {floorRooms.map(room => {
                            ...
                            return (
                              <div
                                key={room._id}
                                className="p-4 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-200 bg-white"
                              >
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex items-center space-x-3">
                                    <div className="p-2 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 text-blue-600 shadow-inner">
                                      <Home size={18} />
                                    </div>
                                    <div>
                    ...
                    <div key={activity.id} className="flex items-start space-x-4 p-4 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-white to-gray-50/50">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-3">
                          ...
                          <span className="text-xs text-gray-400 bg-blue-50 px-2 py-1 rounded-lg border border-blue-200">{activity.time}</span>
                        </div>
                      </div>
                    </div>
                  ))}
