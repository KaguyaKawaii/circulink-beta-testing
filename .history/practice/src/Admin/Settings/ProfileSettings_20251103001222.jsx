...
import AdminNavigation from "../AdminNavigation"; // Add this line


function ProfileSettings({ setView, admin, onLogout }) { // Add setView here
  ...
  return (
    <>
        <AdminNavigation setView={setView} currentView="profileSettings" onLogout={onLogout} />
