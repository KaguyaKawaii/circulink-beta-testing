...
function AdminLogs({ setView }) {
  ...
  return (
    <>
      ...
      <main className={`${isConsoleFullscreen ? 'ml-0 w-full' : 'ml-[250px] w-[calc(100vw-250px)]'} min-h-screen bg-gray-50 transition-all duration-300`}>
        ...
        {/* ✅ Logs Container - Proper width calculation */}
        <div className={`${isConsoleFullscreen ? 'fixed inset-0 z-40' : 'px-6 pb-6'} ${!isConsoleFullscreen ? 'bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden' : 'bg-gray-900'}`}>
          ...
          {loading ? (
            ...
            <div className={`bg-gray-900 text-gray-300 ${isConsoleFullscreen ? 'h-[calc(100vh-80px)]' : 'rounded-lg border border-gray-700'} overflow-hidden`}>
              ...
              {/* Console Content */}
              <div className={`${isConsoleFullscreen ? 'h-full' : 'max-h-[60vh]'} overflow-y-auto font-mono`}>
