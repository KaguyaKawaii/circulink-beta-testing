...
const Icon = {
  ...
  Sort: ({ order }) => (
    <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={order === "desc" ? "M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" : "M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4"} />
    </svg>
  ),
  Table: () => (
    <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function AdminLogs({ setView }) {
  ...
  const getUniqueUserCount = () => {
    return new Set(logs.map(log => log.userName).filter(name => name)).size;
  };

  // Get today's logs count
  const getTodaysLogsCount = () => {
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
              <div className="text-2xl font-bold mb-1">{logs.length}</div>
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
              <div className="text-2xl font-bold mb-1">
                {logs.filter(l => l.action && l.action.toLowerCase().includes('login')).length}
              </div>
              <div className="text-green-100 text-sm">User Logins</div>
              <Icon.Users />
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg">
              ...
              <div className="text-orange-100 text-sm">Today's Activities</div>
              <Icon.Clock />
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            {loading ? (
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                              <div className={`w-10 h-10 rounded-full flex items-center justify-center shadow-sm
                                ${log.userName ? 'bg-gradient-to-br from-blue-500 to-blue-600' : 'bg-gradient-to-br from-gray-500 to-gray-600'}`}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right">
                            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              <button 
                                ...
                                title="Copy Details"
                                onClick={() => {
                                  navigator.clipboard.writeText(`${log.userName} - ${log.action} - ${log.details}`);
                                  showAlert("Success", "Log details copied to clipboard", "success");
                                }}
                              >
                                <Icon.Clipboard />
                              </button>
              ...
              // Enhanced Console View
              <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden font-mono">
                {/* Console Header */}
                <div className="bg-gray-800 px-4 py-3 border-b border-gray-700 flex items-center gap-3">
                  ...
                  <div className="text-gray-400 text-sm">terminal — activity-logs — live</div>
                </div>
                
                {/* Console Content */}
                <div className="p-4 max-h-[60vh] overflow-y-auto">
                  {filteredLogs.map((log, index) => (
                    <div key={log._id} className="mb-3 last:mb-0 group">
                      <div className="flex items-start gap-3 text-sm hover:bg-gray-800 px-2 py-1 rounded transition-colors">
