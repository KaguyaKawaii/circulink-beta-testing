    ...
    return (
      <main className="min-h-screen bg-[#1e1e1e] flex items-center justify-center p-4">
        <div className="w-full max-w-4xl flex flex-col md:flex-row bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-800">
          {/* Left Panel */}
          <div className="md:w-2/5 bg-gradient-to-br from-red-900 to-red-800 p-12 flex flex-col justify-center items-center text-center">
            <div className="mb-8">
              <img 
                src={Logo} 
                alt="University of San Agustin Logo" 
                className="h-32 w-32 bg-white/10 p-4 rounded-full backdrop-blur-sm mx-auto"
              />
            </div>
            <h1 className="text-3xl font-bold text-white mb-3">University of San Agustin</h1>
            <h2 className="text-xl font-semibold text-red-100 mb-6">Learning Resource Center</h2>
    ...
    <main className="min-h-screen bg-[#1e1e1e] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-800">
        ...
        <div className="md:w-2/5 bg-gradient-to-br from-red-900 to-red-800 p-12 flex flex-col justify-center items-center text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-3">University of San Agustin</h1>
          <h2 className="text-xl font-semibold text-red-100 mb-6">Learning Resource Center</h2>
          <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full mb-8">
            <p className="text-white font-semibold">Admin Portal</p>
          </div>
          <div className="mt-8">
            <p className="text-red-100/80 text-sm mb-2">Secure Administrative Access</p>
            <p className="text-red-100/60 text-xs">For authorized personnel only</p>
          </div>
        </div>
            ...
            {requiresOTP ? (
              ...
              <form onSubmit={handleOTPVerification} className="space-y-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-red-900/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-red-800/50">
