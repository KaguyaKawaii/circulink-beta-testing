...
function Login_User({ onSwitchToSignUp, onLoginSuccess, setView }) {
  ...
  return (
    <main className="min-h-screen w-screen bg-white md:bg-gradient-to-br md:from-blue-50 md:via-white md:to-yellow-50 flex items-center justify-center  overflow-x-hidden">
      {loading && (
        <div 
