...
function Login_User({ onSwitchToSignUp, onLoginSuccess, setView }) {
  ...
  return (
    <main className="min-h-screen w-screen bg-white md:bg-gradient-to-br md:from-blue-50 md:via-white md:to-yellow-50 flex items-center justify-center p-0 m-0 overflow-x-hidden">
      ...
      {/* Error Messages - Responsive Positioning */}
      <div className="fixed inset-0 z-40 flex items-center justify-center pointer-events-none md:items-start md:justify-center md:pt-4">
        {error && (
          <div
            key={error}
            className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 md:p-4 rounded-lg shadow-lg animate-fade-in-down max-w-md w-[95%] mx-4 pointer-events-auto md:mt-4"
            role="alert"
          >
