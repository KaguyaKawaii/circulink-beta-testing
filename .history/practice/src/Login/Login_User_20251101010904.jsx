...
const handleLogin = async (e) => {
  ...
  try {
    // ✅ Use direct API call instead of AuthService.loginUser
    ...
    // ✅ The error will now include "already logged in" messages from the backend
