...
const handleAdminLoginSuccess = (adminData) => {
  ...
  // ✅ FIXED: Always allow admin to proceed to OTP verification during maintenance
  // The actual route redirection happens after OTP verification
  console.log("Admin login success during maintenance:", {
    maintenanceMode: maintenanceData.maintenanceMode,
    allowAdminAccess: maintenanceData.allowAdminAccess,
    adminData
  });
  
  // Don't redirect to maintenance screen here - let the OTP flow complete first
  // The final route will be set after OTP verification in the admin login component
};
