...
function StaffMessages({ setView, staff, onLogout }) {
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (msg) => {
      ...
      if (activeTab === "floor" && selectedUser) {
        ...
        if (isRelevantMessage) {
          ...
          // Mark as read if message is from the user
    ...
    const handleConversationMarkedRead = (data) => {
  ...
  const sendMessage = async () => {
    ...
    if (activeTab === "floor" && selectedUser) {
      ...
      try {
        ...
        // MARK AS READ: When staff replies, mark conversation as read
      ...
      try {
        ...
        // Mark admin conversation as read when sending
        await markAdminMessagesAsRead();
