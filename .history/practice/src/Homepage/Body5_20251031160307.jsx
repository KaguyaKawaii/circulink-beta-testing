      ...
      <div className="max-w-6xl mx-auto space-y-16 sm:space-y-20 lg:space-y-24 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {serviceHours.map((term, termIndex) => (
            ...
            >
              {/* Term Icon */}
              <div className="absolute -top-3 sm:-top-4 left-4 sm:left-6 bg-gradient-to-r from-[#CC0000] to-[#990000] p-2 sm:p-3 rounded-full shadow-lg">
                <term.icon className="text-white w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
              </div>
              
              {/* Term Title */}
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#CC0000] mb-2 sm:mb-3 mt-1 sm:mt-2">
                {term.title}
              </h2>
