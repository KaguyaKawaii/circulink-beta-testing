              ...
              <form onSubmit={handleProfileSubmit}>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-11 right-3 group">
                      ...
                      <div className="absolute bottom-full right-0 mb-2 w-48 p-3 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-lg z-10">
                        Email cannot be changed for security reasons. Please contact support if needed.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-3 px-8 rounded-lg font-medium transition-all shadow-sm hover:shadow-md active:scale-[0.98] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-auto">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Update Profile Photo</h2>
              <p className="text-sm text-gray-600 mt-1">Crop your image for the best HD quality</p>
            </div>

            <div className="p-6">
              {!modalImgSrc ? (
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-red-500 transition-colors duration-300">
                  <svg
                  ...
                  <div className="mt-4">
                    <label className="cursor-pointer">
                      <span className="bg-red-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-red-700 transition-colors duration-300 inline-block">
                        Select Image
                      </span>
                      <input
                        type="file"
                    ...
                    <p className="text-xs text-gray-500 mt-3">Supports: JPEG, PNG, WebP, GIF • Max 10MB</p>
                  </div>
                </div>
              ) : (
                <div className="space-y-4">
                  <div className="flex justify-center bg-gray-50 rounded-lg p-4">
                    ...
                    >
                      <img
                        ...
                        alt="Crop preview"
                        className="max-h-64 md:max-h-80 rounded-lg"
                        style={{ display: "block" }}
                        onError={(e) => {
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-end pt-4">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                      {uploading ? "Uploading..." : "Save HD Photo"}
                    </button>
                  </div>
                </div>
              )}
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex justify-end">
              <button
                ...
                className="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors duration-300 cursor-pointer"
              >
                Cancel
              </button>
            </div>
