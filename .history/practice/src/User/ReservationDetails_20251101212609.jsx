            ...
            <div className="space-y-4 mb-6">
                ...
                <div className="max-h-60 overflow-y-auto border border-gray-200 rounded-lg">
                  {availableUsers.map((user) => (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-medium text-gray-800">{getParticipantName(user)}</p>
                          <p className="text-sm text-gray-600">ID: {getParticipantId(user)}</p>
                        </div>
              ...
              {selectedUser && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="font-medium">{getParticipantName(selectedUser)} (ID: {getParticipantId(selectedUser)})</p>
                    ...
                    localReservation.participants.map((participant, index) => (
                      <div key={index} className="flex justify-between items-center p-4 bg-white rounded-lg border border-gray-200 hover:border-gray-300 transition-colors shadow-sm">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">{getParticipantName(participant)}</p>
                            <p className="text-sm text-gray-600">ID: {getParticipantId(participant)}</p>
                          </div>
                        </div>
                        <button
