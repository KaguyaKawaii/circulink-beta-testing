...
// FIXED: Updated room-to-image mapping with correct room names
const getRoomImage = (room) => {
  ...
  const directMappings = {
    ...
    // 2nd Floor Discussion Rooms - UPDATED NAMES
    ...
    // 2nd Floor Faculty Rooms - UPDATED NAMES
