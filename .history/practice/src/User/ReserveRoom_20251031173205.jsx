...
// FIXED: Enhanced room-to-image mapping for 2nd floor Faculty Rooms
const getRoomImage = (room) => {
  ...
  const directMappings = {
    ...
    // 2nd Floor Faculty Rooms - FIXED: Added all possible name variations
    ...
    "Faculty Room": "2nd_faculty_room_1_2", // fallback
  ...
  // Enhanced fallback based on floor and room type
  if (room.floor === "Ground Floor") {
    return getRoomImageById("ground_floor")?.url;
  } else if (room.floor === "2nd Floor") {
    // Check if it's a faculty room and use faculty room image
    if (room.room.includes("Faculty") || room.room.includes("faculty")) {
      return getRoomImageById("2nd_faculty_room_1_2")?.url || getRoomImageById("second_floor_1")?.url;
    }
