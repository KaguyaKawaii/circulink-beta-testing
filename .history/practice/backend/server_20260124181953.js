...
// ✅ FIXED: Consistent API routes with proper paths
...
// ✅ FIXED: Use specific paths instead of generic /api
  ...
  .then(() => {
    ...
    cron.schedule("*/5 * * * *", async () => {
      try {
        ...
        // Check if we should use the API route or internal function
        // For self-referential calls, use internal function to avoid CORS issues
